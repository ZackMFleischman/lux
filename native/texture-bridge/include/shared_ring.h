...
struct SharedRing { uint32_t version=1,pid=0; uint64_t generation=0,outputGeneration=1; LUID adapter{}; volatile LONG alive=1; volatile LONG controlBits=0; SharedSlot slots[3]; };
