...
| Additional declared-control host coverage | In progress | Verify a visual with several code-defined controls in the real host. | Lux Spike Sphere is installed in Resolume's source folder with all five saved controls. Package, supervisor startup/singleton/shutdown and 104 runtime files validated; real-host gestures and persistence remain. |
