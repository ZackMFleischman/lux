...
5. The UI automatically shows the successful revision and one request-level Undo/summary. A failed build, timeout or first frame leaves the selected revision unchanged. Dispose the candidate; keep the previous validated bundle for restoration.
