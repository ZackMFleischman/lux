...
Detailed contract: [Filesystem projects and accepted revisions](filesystem-projects.md), with [implementation plan](../implementation/filesystem-projects-plan.md) and [independent review record](../reviews/filesystem-projects-review.md). This document supersedes the older working-projection regeneration design for directory projects.
