...
| TR-02 | `native/texture-bridge/src/telemetry.cc`, `native/ffgl-source/src/Telemetry.cpp`; native clock/frame/control counters and bounded writer path. Verify nonblocking collection and actual GPU/frame provenance before broader work. |
