...
| IN PROGRESS | TypeScript editor and multi-file draft state | source_editor + review / source-editor | Integrated through 6e2e27a; real Electron syntax/tabs/undo/CSP checks passed. Independent review found rejected-edit/diagnostic bugs being repaired; failed-open control preservation fixed by coordinator. |
...
| IN PROGRESS | Shared installed runtime, automatic source startup, independent instances | review_mcp / installed-runtime | Integrated 2b0dc52/a980bd6; coordinator rebuilt native, all 11 CTest checks pass. Independent code audit and actual installed acceptance pending. |
| IN PROGRESS | Export action in Studio and cold-start/reopen QA | Coordinator + source_editor | Backend b1e40c0 and native-dialog installer f311add integrated; real Studio package workflow test running. No installed playback claim yet. |
...
| IN PROGRESS | Review/integrate source editor; automated Studio UI QA | Coordinator + independent reviewer | Native editor/preview continuity passed; fixing three review findings and improving dark syntax contrast before final combined QA. |
