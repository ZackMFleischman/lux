...
| Dockable Source | Adopted Dockview adapter | Move Source among groups without text/history loss; laptop tab changes never restart Preview; layout restore cannot select an unrelated file. |
