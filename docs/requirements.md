...
| C03 | Useful diagnostics and optional analytical measurements; provenance includes revision/time/input/settings; capture downsize distinct from render override. | 3 | D 7 |
