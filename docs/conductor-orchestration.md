...
| --- | --- | --- |
| Filesystem projects, LUX-2 | Metadata/C01 and pure resolver integrated; LUX-24 accepted. Offline tooling plan revision 2 `b57a03112c428fd9c709e02da1f6867e1510e7d6` independently accepted and integrated. | LUX-31 source review found an omitted wildcard metadata branch. Assigned fresh worker `lux-tooling-wildcard-rework-01a09967` is correcting complete branch accounting; source remains unaccepted. Later editor/checker/repair/offline-host gates remain explicit; LUX-7 acquisition remains stopped. |
| Components, LUX-3 | C02 and C03a integrated and accepted as LUX-21/LUX-34. C03b nested graph plan `ce7a82e940cb0dd9403fc1ecb8a3e08b84d2b8f1` independently accepted as LUX-35 and integrated. | LUX-38 six-file pure nested graph and public binding implementation is assigned and active. C03c scheduler/resources and C03d feedback require later plans; no graph execution profile is exposed. |
| Creative controls and inputs, LUX-4 | I01, I02a and I02b integrated. Live timeline main `c8d6c9f38e6df52d34bbed66599b1c74eb40315b` verified and accepted as LUX-36. Controlled replay plan revision2 `2a4d3dc038aa994c1cadd9446873bc28538ba6b1` independently accepted as LUX-39 and integrated. | Next implementation is the four-file scripted fixture admission/hash contract, including complete authored base and explicit Studio authority. Controlled cursor, live-capture provenance and runtime/device adapters remain separate leaves. |
| Reliability, LUX-5 | R1, R2a and R2b-a integrated. Timing source `78fe89de0ab3ece30057c094115b5051ff2e095d` independently accepted as LUX-33; main `6d5c474bc09d6f2dcd9e42f5fbedd7e833e7ed27` verified and accepted as LUX-40. | LUX-41 assigns root the next paired-package/evidence plan. Package source attribution, physical child observation, graphics/performance and installed-host gates remain separate. |
