...
| Components, LUX-3 | C02 and C03a integrated and accepted as LUX-21/LUX-34. C03b nested graph plan `ce7a82e940cb0dd9403fc1ecb8a3e08b84d2b8f1` independently accepted as LUX-35 and integrated. | Next delivery is the six-file pure nested graph and public binding implementation. C03c scheduler/resources and C03d feedback require later plans; no graph execution profile is exposed. |
| Creative controls and inputs, LUX-4 | I01, I02a and I02b integrated. Live timeline source `4121e179353efa8064c48f6218e7772158c77ca8` independently accepted as LUX-32; main `c8d6c9f38e6df52d34bbed66599b1c74eb40315b` verified and accepted as LUX-36. | Next planning leaf freezes controlled replay fixture identity, effective step placement and complete delivery. Runtime/device adapters remain later leaves. |
| Reliability, LUX-5 | R1 diagnostics and R2a source ownership integrated, LUX-18/LUX-28 accepted at main `3003a407cbd371ef89cd1ce018c76a2104a7c7a0`. R2b timing plan `8e97f9263928ee28a9c38119b7d99e093cacf291` independently accepted and integrated. | LUX-33 source `78fe89de0ab3ece30057c094115b5051ff2e095d` submitted with eight Release targets, seven native CPU checks and sixteen JS checks passing; independent source review underway. Package/paired graphics/performance gates remain separate. |
