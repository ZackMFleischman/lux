...
- User follow-up: dedicated [performance-monitoring design](design/performance-monitoring.md) committed as `0160de1`; describes instrumentation, modes, GPU/CPU/UI/host boundaries, calibration, resource monitoring, overhead and negative validation fixtures. Linked into architecture, task plan, acceptance and handoff; focused technical review and final doc checks follow before this addendum is finished.
