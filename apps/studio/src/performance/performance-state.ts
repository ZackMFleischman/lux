...
function summary(raw:any):FrameSummary {
 if(!raw||raw.schemaVersion!==1||raw.mode!=='routine'||raw.clockDomain!=='dedicated-worker-monotonic-ms'||
 ...
 const result:any={schemaVersion:1,mode:'routine',clockDomain:raw.clockDomain,sequence:raw.sequence,windowStartMs:raw.windowStartMs,windowEndMs:raw.windowEndMs};
